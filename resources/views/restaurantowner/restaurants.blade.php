...
<style>
	...
	.clr_chng{background-color:#00a700!important;}
</style>
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                ...
                <span class="badge badge-primary clr_chng badge-pill animated flipInX">{{ count($restaurants) }}</span>
            </h4>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    <a href="{{ route('restaurant.get.editRestaurant', $restaurant->id) }}"
                                        class="btn btn-sm btn-primary clr_chng"> {{__('storeDashboard.edit')}}</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
