...
<div class="content">
    <div class="row">
        <div class="col-lg-8 mt-4">
            ...
            <a href="javascript:void(0)" id="printButton" class="btn btn-sm btn-primary my-2" style="color: #fff; border: 1px solid #00a700; float: right;border-radius: 8px;background:#00a700;"><i class="icon-printer mr-1"></i> Print Bill</a>
            ...
            <div class="card" id="printThis">
                <div href="#" class="btn btn-block content-group" style="text-align: left; background-color: #00a700; color: #fff; border-radius: 8px 8px 0 0;"><strong style="font-size: 1.2rem;">{{ $order->unique_order_id }}</strong>
                </div>
                <div class="p-3">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ config('appSettings.currencyFormat') }}{{ number_format($addon->addon_price,2) }}</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                        ...
                        <div class="float-right">
                            <table class="table table-bordered table-striped bill-calc-table">
                                ...
                                <tr>
                                    ...
                                    <td class="td-data"> {{ config('appSettings.currencyFormat') }}{{ number_format($subTotal,2) }}</td>
                                </tr>

                                @if($order->coupon_name != NULL)
                                    <tr>
                                        <td class="text-left td-title">Coupon</td>
                                        <td class="td-data"> {{ $order->coupon_name }} @if($order->coupon_amount != NULL) ({{ config('appSettings.currencyFormat') }}{{number_format($order->coupon_amount,2) }}) @endif </td>
                                    </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td class="td-data"> {{ config('appSettings.currencyFormat') }}{{ number_format($order->restaurant_charge,2) }} </td>
                                </tr>
                                @endif

                                <tr>
                                    <td class="text-left td-title">Delivery Charge</td>
                                    <td class="td-data"> {{ config('appSettings.currencyFormat') }}{{ number_format($order->delivery_charge,2) }} </td>
                                </tr>

                                @if($order->tax != NULL)
                                    <tr>
                                        <td class="text-left td-title">Tax</td>
                                        <td class="td-data">{{ $order->tax }}% @if($order->tax_amount != NULL) ({{ config('appSettings.currencyFormat') }}{{ number_format($order->tax_amount,2) }}) @endif </td>
                                    </tr>
                                @endif
                                ...
                                @if(!$order->tip_amount == NULL)
                                    <tr>
                                        ...
                                        <td class="td-data">{{ config('appSettings.currencyFormat') }}{{  number_format($order->tip_amount,2) }}</td>
                                    </tr>
                                @endif
                                ...
                                @if($order->wallet_amount != NULL)
                                    <tr>
                                        ...
                                        <td class="td-data"> {{ config('appSettings.currencyFormat') }}{{  number_format($order->wallet_amount,2) }} </td>
                                    </tr>
                                @endif

                                <tr>
                                    <td class="text-left td-title"><b>TOTAL</b></td>
                                    <td class="td-data"> {{ config('appSettings.currencyFormat') }}{{  number_format($order->total,2) }} </td>
                                </tr>

                                @if($order->payable != NULL)
                                    <tr>
                                        <td class="text-left td-title">Payable</td>
                                        <td class="td-data"><b> {{ config('appSettings.currencyFormat') }}{{  number_format($order->payable,2) }}</b></td>
                                    </tr>
                                @endif
                ...
                <div class="card-body">
                    ...
                    <div class="form-group d-flex justify-content-center">
                        ...
                        <form action="{{ route('admin.acceptOrderFromAdmin') }}" class="mr-1" method="POST">
                            ...
                            @csrf
                            <button 
                                class="btn btn-success btn-labeled btn-labeled-left mr-1"> <b><i
