...
@section('content')
<style>
	.nav-pills .nav-link.active, .nav-pills .show > .nav-link{background:#00a700!important;}
</style>
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Sorting Menu and Items for: <a class="color_chng" href="{{ route('admin.get.editRestaurant', $restaurant->id) }}"><b>{{ $restaurant->name }}</b></a></span>
            </h4>
