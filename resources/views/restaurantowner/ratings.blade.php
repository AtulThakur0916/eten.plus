...
@section('content')
<style>
	.chng_clr{color:#00a700!important;}
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">{{ __('storeDashboard.ratingsPageReviewsOfTitle') }} <a class="ml-1 chng_clr" href="{{ route('admin.get.editRestaurant', $restaurant->id) }}">{{ $restaurant->name }}</a></span> <span class="ml-1 badge badge-flat text-white {{ ratingColorClass($averageRating) }}">{{ $averageRating }} <i class="icon-star-full2 text-white" style="font-size: 0.6rem;"></i></span>
            </h4>
