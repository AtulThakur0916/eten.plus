...
@section('content')
<style>
	.dashboard-display-number{color:#00a700!important;}
</style>
                ...
                <a class="block block-link-shadow text-left" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix">
                        ...
                        <div class="dashboard-display-number">{{ config('appSettings.currencyFormat') }}
                            {{ number_format(floatval($totalEarning),2) }}
                        </div>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('restaurant.viewOrder', $nO->unique_order_id) }}"
                                        class="letter-icon-title" style="color:#00a700;">{{ $nO->unique_order_id }}</a>
                                </td>
                                <td class="text-center new-order-actions">
                                    <a href="javascript:void(0)"
                                        class="btn btn-success btn-labeled btn-labeled-left mr-2 accpetOrderBtnTableList" data-id={{ $nO->id }}> <b><i
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('restaurant.viewOrder', $pO->unique_order_id) }}"
                                        class="letter-icon-title" style="color:#00a700;">{{ $pO->unique_order_id }}</a>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('restaurant.viewOrder', $spO->unique_order_id) }}"
                                        class="letter-icon-title" style="color:#00a700;">{{ $spO->unique_order_id }}</a>
                                </td>
                                <td class="text-center accepted-order-actions">
                                ...
                                <td>
                                    <span class="text-semibold no-margin">{{ config('appSettings.currencyFormat') }}
                                    {{ number_format($spO->total,2) }}</span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('restaurant.viewOrder', $ogO->unique_order_id) }}"
                                        class="letter-icon-title" style="color:#00a700;">{{ $ogO->unique_order_id }}</a>
                                </td>
                                <td class="text-center accepted-order-actions">
