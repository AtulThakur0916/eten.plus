                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified align-items-center">
                                    ...
                                    <div class="checkbox checkbox-switchery chng_clr ml-1" style="padding-top: 0.8rem;">
                                        <label>
                                        <input value="true" type="checkbox" class="action-switch chng_clr"
    ...
    <div class="card">
        ...
        <div class="card-body pt-0 pb-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <div class="checkbox checkbox-switchery chng_clr" style="padding-top: 0.93rem;">
                        <label>
