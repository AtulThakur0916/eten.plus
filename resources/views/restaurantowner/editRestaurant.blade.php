    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                ...
                <span class="badge badge-success badge-pill animated flipInX">"{{ $restaurant->name }}"</span>
            </h4>
                        ...
                        <fieldset class="gllpLatlonPicker">
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-lg-6 d-flex location-search-block">       
                                    ...
                                    <button type="button" class="btn btn-success gllpSearchButton">{{__('storeDashboard.seLblSearch')}}</button>
                                </div>
                            </div> --}}
                            <span class="text-muted" >{{__('storeDashboard.sePhTextLatLong1')}} <a style="color:#00a700;" href="https://www.mapcoordinates.net/en" target="_blank">https://www.mapcoordinates.net/en</a></span> <br> {{__('storeDashboard.sePhTextLatLong2')}}
                        </fieldset>
                        <hr>
                        <div class="form-group row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('restaurant.updateRestaurantScheduleData') }}" method="POST"
                        ...
                        @csrf
                        <div class="text-right">
                            <button type="submit" class="btn btn-success" data-popup="tooltip" title="{{ __('storeDashboard.seScheduleUpdateMsg') }}" data-placement="bottom">
                            {{ __('storeDashboard.update') }}
                            <i class="icon-database-insert ml-1"></i>
                            </button>
                        </div>
