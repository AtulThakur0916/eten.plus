    ...
    <div class="col-md-12">
        <div class="card" style="min-height: 100vh;">
            ...
            <div class="tab-pane fade" id="fixUpdateIssues">
                ...
                <a href="{{ route('admin.fixUpdateIssues') }}" class="btn btn-lg btn-success" id="fixUpdateIssuesButton">Fix Issues Now</a>
            </div>
            <div class="tab-pane fade" id="advanceSettings">
                ...
                <div class="mt-5">
                    ...
                    <a href="{{ route('admin.filesBackup') }}" class="btn btn-success btn-labeled btn-labeled-left backupBtn mr-2">
                    <b><i class="icon-folder-download2"></i></b>
                    Files Backup
                    </a>
                    <a href="{{ route('admin.dbBackup') }}" class="btn btn-success btn-labeled btn-labeled-left backupBtn">
